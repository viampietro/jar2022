...
clarification of both the definition of the SITPN structure and its
semantics. Moreover, we added complementary definitions that are
required to express the semantic preservation theorem about the
\hilecop{} model-to-text transformation
(cf. Section~\ref{sec:proof}). Our main contribution in this part
