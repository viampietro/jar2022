...
amounts to 5200 lines of program and specification and 7000 lines of
proof script. The code of the current version of the SITPN structure
and semantics is accessible under the \texttt{sitpn} folder in our
\textsf{Git} repository; it amounts to 680 lines of programs and
specifications.
...
% COMMAND RUN TO COUNT PROG, SPECS AND PROOF LINES:
% 
% coqwc $(find common/ sitpn/proofs/ hvhdl/proofs/ transformation/proofs/ behavior-preservation/ -name *.v ! -regex common/DFMapWeakList.v)
%
